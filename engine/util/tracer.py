...
#from reporter.engine.util.dbg import dbg_funcname, dbg_func
from reporter.engine.util.dictOrder import dictOrder
from reporter.engine.util.attr import get_itemer
...
def trace_inside( func):
    ...
    return explfunc
    #from reporter.engine.util.tracer import Tracer
